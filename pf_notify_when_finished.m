...
% Created by Beicun Li (John Resse) at 2015-10-24 17:45. Contact mister.resse@outlook.com.

function pf_notify_when_finished()
    fprintf('- Calculation finished.\n');
    fprintf('- The process returns successfully.\n');
